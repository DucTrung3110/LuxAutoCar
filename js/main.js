...
function initCarData() {
    ...
    featuredCars = [
        {
            ...
            description: 'The BMW X7 combines luxury with performance in a stunning SUV package.',
            badge: 'New'
        },
        {
            id: 2,
            ...
            description: 'The Mercedes S-Class sets the standard for luxury sedans worldwide.',
            badge: 'Featured'
        },
        {
            id: 3,
            ...
            description: 'The Tesla Model S Plaid delivers unprecedented electric performance.',
            badge: 'Electric'
        }
    ];
    ...
    if (featuredCarsGrid) {
        renderFeaturedCars();
        // Initialize modal after rendering cars
        setTimeout(() => {
            initModal();
        }, 100);
    }
            ...
            <article class="car-card">
                ...
                <div class="car-info">
                    ...
                    <div class="car-actions">
                        <button class="btn btn-primary" onclick="openVehicleModal(${car.id})">View Details</button>
